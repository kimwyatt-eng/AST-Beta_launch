...
export default function ArtistsHome() {
  return (
    <main className="min-h-screen w-full bg-background text-foreground">
      <Seo
        title="Your Studio Time Is For Making Art"
        description="Track supplies, projects, notes, and materials without breaking your creative flow."
        path="/"
      />
      <Navigation />
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            },
            {
              title: "Create & track",
              body:
                "Organize projects, link supplies to the work they belong to, and keep notes in one place.",
              num: 2,
            },
            {
              title: "Relax",
