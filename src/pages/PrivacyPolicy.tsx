      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="rounded-2xl border-4 border-yellow-600/50 bg-yellow-600/5 p-8 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
              <img 
                src={trustBadges} 
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 space-y-10">
        ...
        <PolicyBlock title="Contact & Updates">
          <p className="text-white/85">
            ...
            <a href="mailto:info@notify.artsupplytracker.com" className="text-teal-300 underline underline-offset-4">
